<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="highSchoolScoreInput6.aspx.cs" Inherits="KJC.IMS.ENTR.StaffMngr.highSchoolScoreInput6" MasterPageFile="/Page.Master" %>
...
<asp:Content ID="header" ContentPlaceHolderID="HeadContent" runat="server">
    <script type="text/javascript">
        ...
        function OpenModal() {
            ...
            var height = 950;
            var src = 'ApplScoreUpload6.aspx?year=' + year + '&recpNo=' + recpNo;
                        ...
                        <cc2:ComDivScroll ID="ComDivScroll3" runat="server" Style="height: 228px">
                            <cc1:ExGridView ID="grdList3" runat="server"
                                ...
                                <Columns>
                                    ...
                                    <%--13--%><asp:BoundField DataField="SeqNumber" HeaderStyle-CssClass="skip" ItemStyle-CssClass="skip" />
                                    <%--14--%><asp:TemplateField HeaderText="선택" ItemStyle-Wrap="False"  Visible="False">
