<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="highSchoolScoreRatingStatistics.aspx.cs" Inherits="KJC.IMS.ENTR.StaffMngr.highSchoolScoreRatingStatistics"  MasterPageFile="~/Page.Master"%>
    ...
    <div class="subcont">
        <div class="table-filter">
            <div class="form-inline" id="divPrint">
                ...
                <div class="form-group form-group-sm">
                    <asp:Label runat="server" CssClass="control-label m-r-xs" AssociatedControlID="ddlType">과정구분 :</asp:Label>
                    <cc1:ExDropDownList ID="ddlType" runat="server" CssClass="form-control" CodeType="_공통" P1="SA03" Width="160px" BindMode="All" Required="True" Group="ExToolBar1_Etc1" Description="과정구분" ToolTip="과정구분"></cc1:ExDropDownList>
                </div>   
                <div class="form-group form-group-sm">
                    <asp:Label runat="server" CssClass="control-label m-r-xs" AssociatedControlID="rdGbn">구분 :</asp:Label>
                    <cc1:ExRadioButtonList ID="rdGbn" runat="server" CssClass="form-control" Group="ExToolBar1_Etc1" Description="구분" ToolTip="구분" RepeatDirection="Horizontal" Required="true">
                        <asp:ListItem Value="1" Selected="True">응시자</asp:ListItem>
                        <asp:ListItem Value="2">합격자</asp:ListItem>
                        <asp:ListItem Value="3">등록자</asp:ListItem>
