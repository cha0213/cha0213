<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FreshmanFeeEnrollStatistics2.aspx.cs" Inherits="KJC.IMS.ENTR.StaffMngr.FreshmanFeeEnrollStatistics2" MasterPageFile="~/Page.Master" %>
    ...
    <div class="subcont">
        <div class="table-filter">
            <div class="form-inline" id="divPrint">
                ...
                <div class="form-group form-group-sm">
                    <asp:Label runat="server" CssClass="control-label m-r-xs" AssociatedControlID="rdGbn">교장추천자 :</asp:Label>
