<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FreshmanFinalRecruitment.aspx.cs" Inherits="KJC.IMS.ENTR.StaffMngr.FreshmanFinalRecruitment" MasterPageFile="~/Page.Master"%>
    ...
    <div class="subcont">
        <div class="table-filter">
            <div class="form-inline" id="divPrint">
                ...
                <div class="form-group form-group-sm">
                    <asp:Label runat="server" CssClass="control-label m-r-xs" AssociatedControlID="rdoGbn">전형별구분 :</asp:Label>
                    <cc1:ExRadioButtonList ID="rdoGbn" runat="server" RepeatDirection="Horizontal">
                        <asp:ListItem Value="1" Selected="True">정원내</asp:ListItem>
                        <asp:ListItem Value="2">정원외</asp:ListItem>
