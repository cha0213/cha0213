<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AcademicStatistics.aspx.cs" Inherits="KJC.IMS.ENTR.StaffMngr.AcademicStatistics" MasterPageFile="~/Page.Master" %>
            ...
            <div class="form-inline" id="divPrint">
                ...
                <div class="form-group form-group-sm">
                    ...
                    <cc1:ExRadioButtonList ID="rdGbn" runat="server" CssClass="form-control" Group="ExToolBar1_Search;ExToolBar1_Print" Description="구분" ToolTip="구분" RepeatDirection="Horizontal" Required="true">
							<asp:ListItem Value="01" Selected="True">지원자</asp:ListItem>
                            <asp:ListItem Value="02">합격자</asp:ListItem>
							<asp:ListItem Value="03">등록자</asp:ListItem>
