<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApplScoreUpload.aspx.cs" Inherits="KJC.IMS.ENTR.StaffMngr.ApplScoreUpload" MasterPageFile="~/Modal.Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="subcont">
        ...
        <ol>            
            <li>업로드 샘플 파일을 다운로드해서 데이터를 입력하시기 바랍니다. (<a href="학생부 업로드 샘플파일.xlsx" target="_blank">학생부 업로드 샘플파일.xlsx</a>)
            </li>
