<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SendSMSAppl.aspx.cs" Inherits="KJC.IMS.ENTR.StaffMngr.SendSMSAppl" MasterPageFile="~/Page.Master" %>
            ...
            <div class="table-filter">
                <div class="form-inline">
                    ...
                    <div class="form-group form-group-sm">
                        ...
                        <cc1:ExTextBox ID="txt연도" runat="server" CssClass="form-control" Width="55px" ToolTip="연도" Description="연도" MaxLength="4" FixLength="4" Required="true" Group="ExToolBar1_Search"></cc1:ExTextBox>
                    </div>
                    <!-- 시기 -->
                    <div class="form-group form-group-sm">
