<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="ApplMajorGuideMsgMngr2.aspx.cs" Inherits="KJC.IMS.ENTR.StaffMngr.ApplMajorGuideMsgMngr2"  MasterPageFile="~/Page.Master" %>
...
<asp:Content ID="Script" ContentPlaceHolderID="HeadContent" runat="server">
    <script type="text/javascript">
        function infoMessagePop(year, season, majorCd, passCd) {
            ...
            var height = 600;
            var src = '/ENTR/StaffMngr/ApplGuideMsgPopUP.aspx?Year=' + year + '&Season=' + season + '&MajorCd=' + majorCd + '&PassCd=' + passCd;
            $(modalId)
                            ...
                            <cc1:ExGridView ID="grdList" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-bordered table-sm" SelectedRowStyle-CssClass="active"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="합격코드">
                                        <HeaderStyle Width="45%" CssClass="text-center" />
                                        <ItemStyle CssClass="text-center" />
                                        <ItemTemplate>
                                            <asp:LinkButton ID="HyperLink1" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.PassNM") %>' CommandName="SELECT"></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <%--2--%><asp:BoundField HeaderText="합격코드" DataField="PassNM" HeaderStyle-Width="10%" HeaderStyle-CssClass="skip" ItemStyle-CssClass="skip" />
                                    ...
                                    <%--5--%><asp:BoundField HeaderText="지원연도" DataField="ApplYear" HeaderStyle-CssClass="skip" ItemStyle-CssClass="skip" />
                                    <%--6--%><asp:BoundField HeaderText="지원시기" DataField="Season" HeaderStyle-CssClass="skip" ItemStyle-CssClass="skip" />
                                    <%--7--%><asp:BoundField HeaderText="합격코드(코드)" DataField="Pass" HeaderStyle-CssClass="skip" ItemStyle-CssClass="skip" />
                                    <%--8--%><asp:BoundField HeaderText="안내메시지" DataField="GuideMsg" HeaderStyle-CssClass="skip" ItemStyle-CssClass="skip" />
                                </Columns>
                            </cc1:ExGridView>
                        </cc2:ComDivScroll>
                    </div>
