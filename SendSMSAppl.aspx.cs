...
namespace KJC.IMS.ENTR.StaffMngr
{
    ...
    public partial class SendSMSAppl : WebFormBase
    {
        ...
        private void InitPageSetting()
        {
            ...
            ((StudSearchControl)StudSearch).Year = this.txt연도.Text.Trim();
            ((StudSearchControl)StudSearch).Season = this.ddl시기.SelectedValue;   
        ...
        {
            DataSet ds = null;
            string spName = "dbo.USP_학사행정_입시_SMS문자서비스_SMS문자서비스개인_조회_업그레이드";
