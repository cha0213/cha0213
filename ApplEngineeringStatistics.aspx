<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApplEngineeringStatistics.aspx.cs" Inherits="KJC.IMS.ENTR.StaffMngr.ApplEngineeringStatistics" MasterPageFile="~/Page.Master" %>
    ...
    <div class="subcont">
        <div class="table-filter">
            <div class="form-inline" id="divPrint">
                ...
                <div class="form-group form-group-sm">
                    <asp:Label runat="server" CssClass="control-label m-r-xs" AssociatedControlID="rdlPassGbn">구분 :</asp:Label>
                    <cc1:ExRadioButtonList ID="rdlPassGbn" runat="server" CssClass="form-control" Group="ExToolBar1_Etc1" Description="구분" ToolTip="구분" RepeatDirection="Horizontal" Required="true">
                        <asp:ListItem Value="1" Text="최종등록률" Selected="True"></asp:ListItem>
                        <asp:ListItem Value="2" Text="예치등록률"></asp:ListItem>
