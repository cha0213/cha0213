...
namespace KJC.IMS.ENTR.StaffMngr
{
    ...
    public partial class FreshmanFeeEnrollStatistics : WebFormBase
    {
        #region 초기화
        ...
        public override void Etc1Cmd(object sender, CommandEventArgs e)
        {
            try
            {
                ...
                //rv1.ShowReportByStoredProcedure("0001491001", "dbo.USP_학사행정_입시_통계_지원경쟁률_조회_업그레이드", dataParams);   // 로컬
                rv1.ShowReportByStoredProcedure("0001494001", "dbo.USP_학사행정_입시_통계_지원경쟁등록률_조회_업그레이드", dataParams);   // 실서버
            }
            catch (Exception ex)
            {
