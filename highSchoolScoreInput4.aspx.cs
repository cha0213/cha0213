...
/// <summary>
/// 메뉴정보 : 입시 > 성적사정 > 고교학생부 입력(2008학년 이후)
/// 수정이력
/// 1. 작성일자/작성자/최초작성
///  - 2017.11.24 / 박영지 / 최초작성
/// 2. 수정일자/수정자/수정내용
...
namespace KJC.IMS.ENTR.StaffMngr
{
    ...
    public partial class highSchoolScoreInput4 : WebFormBase
    {
        #region 전역변수
        ...
        {
            DataSet ds = null;
            string spName = "dbo.USP_학사행정_입시_성적사정_고교학생부입력2007학년이전_조회_업그레이드"; //2007학년이전 프로시저와 동일
        ...
        private void Save()
        {
            ...
            try
            {
                string spName = "dbo.USP_학사행정_입시_성적사정_고교학생부입력2008학년이후_등록_업그레이드";
                var parameters = new DataParameterCollection();
                var shell = new DataCommandShell();
                var dataCommands = new List<DataCommand>();
