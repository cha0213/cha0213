...
namespace KJC.IMS.ENTR.StaffMngr
{
	...
	public partial class highClassGradeList5 : WebFormBase
	{
		#region 초기화
		...
		public override void Etc1Cmd(object sender, CommandEventArgs e)
		{
			try
			{
                ...
                dataParams.Add("@gubun", rdGbn.SelectedValue);

                rv1.ShowReportByStoredProcedure("0001509001", "dbo.USP_학사행정_입시_통계_경남지역별지원합격등록인원현황_조회_업그레이드", dataParams);   // rptHighClassGradeList5
            }
			catch (Exception ex)
			{
