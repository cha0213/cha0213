...
namespace KJC.IMS.ENTR.StaffMngr
{
    ...
    public partial class highSchoolScoreRatingStatistics : WebFormBase
    {
        #region 초기화
        ...
        public override void Etc1Cmd(object sender, CommandEventArgs e)
        {
            try
            {
                ...
                dataParams.Add("@Gunun", rdGbn.SelectedValue);

                rv1.ShowReportByStoredProcedure("0001513001", "dbo.USP_학사행정_입시_통계_수능등급별인원현황_조회_업그레이드", dataParams);   // rptHighSchoolScoreRatingStatistics
			}
			catch (Exception ex)
            {
