...
namespace KJC.IMS.ENTR.StaffMngr
{
	...
	public partial class highClassGradeList9 : WebFormBase
	{
		#region 초기화
		...
		public override void Etc1Cmd(object sender, CommandEventArgs e)
		{
			try
			{
                ...
                rv1.ShowReportByStoredProcedure("0001511001", "dbo.USP_학사행정_입시_통계_연령별지원합격등록인원현황_조회_업그레이드", dataParams);   // rptHighClassGradeList9
            }
			catch (Exception ex)
			{
